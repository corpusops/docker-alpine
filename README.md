...
# library images on steroids for library/alpine
## Wrapped images
- [docker-images](https://github.com/corpusops/docker-images) compatibles images (original images wrapped with tools)
- [![.github/workflows/cicd.yml](https://github.com/corpusops/docker-alpine/workflows/.github/workflows/cicd.yml/badge.svg?branch=main)](https://github.com/corpusops/docker-alpine/actions?query=workflow%3A.github%2Fworkflows%2Fcicd.yml+branch%3Amain)
